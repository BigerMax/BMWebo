//
//  BMWriteController.swift
//  BMWebo
//
//  Created by BiggerMax on 2020/6/9.
...
class BMWriteController: UIViewController {

        var textView = BMTextView()
        var bottomBackgroundView = UIView()
        var toolBar = UIToolbar()
        lazy var sendButton:UIButton = {
            let btn = UIButton()
            btn.frame = CGRect(x: 0, y: 0, width: BMLayout.Layout(45), height: BMLayout.Layout(35))
            btn.titleLabel?.font = UIFont.systemFont(ofSize: BMLayout.Layout(14))
        ...
        //往textView中插入表情符号
        lazy var emojiView: BMWriteControllerMNEmojiInputView = BMEmojiInputView { [weak self](emojiModel) in
        ...
        lazy var titleView:UIView = {
            ...
            topLabel.text = "发微博"
            topLabel.font = UIFont.systemFont(ofSize: BMLayout.Layout(13))
            view.addSubview(topLabel)
            topLabel.snp.makeConstraints { (make) in
                make.centerX.equalToSuperview()
                make.top.equalTo(BMLayout.Layout(10))
            }
            
            userNameLabel.text = "miniLV"
            userNameLabel.font = UIFont.systemFont(ofSize: BMLayout.Layout(12))
        ...
        @objc func keyboardChange(noti:NSNotification){
            ...
            let toolBarOffsetY:CGFloat = BM_iPhoneX ? 34 : 44
            if offset > BM_bottomTabBarHeight{
                //弹出键盘
    ...
    private extension BMWriteController{
        func setupUI() {
        ...
        func setupSubviews(){
            ...
            textView.font = UIFont.systemFont(ofSize: BMLayout.Layout(14))
